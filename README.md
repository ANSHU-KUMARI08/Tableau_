...
Coffee Chain Dataset Visualization
...
🧭 Steps Performed:
Bar Chart: Passengers by Gender.
...
Scatter Plot: Age vs. Fare relationship.
Box Plot: Fare distribution by Passenger Class.
Heat Map: Survival rate by Gender and Class.
Pie Chart: Gender distribution of passengers.
Dashboard: Combined interactive view of all visuals for deeper insights.
🧩 Key Insights:
